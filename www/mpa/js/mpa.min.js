...
function loadAccounts()
{
	...
	$.getJSON("../res/accounts" + tokenQueryString, function(msg)
	{
		if( msg.isAdmin == "true" )
		{
			isAdmin = true;
		...
		$.each(msg.accounts, function(index, account)
		{
			htmlAddAccount( account.id , account.version , account.name , account.balance );
		});
	});
}
...
function restAddCategory()
{
	...
	$.post('../res/accounts/' + accountId + '/categories/0/add', {
		name : categoryName,
		token : mpaToken
	}).done(function(data)
	{
...
function restAddProvider()
{
	...
	$.post('../res/accounts/' + accountId + '/providers/0/add', {
		name : providerName,
		token : mpaToken
	}).done(function(data)
	{
...
function restAddOperation()
{
	...
	//var test = { 1: operationCategory, azerty: operationAmount  };

	$.post('../res/accounts/' + accountId + '/operations/0/add', {
		date : operationDate,
